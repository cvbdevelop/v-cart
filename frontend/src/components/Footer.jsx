...
function Footer() {
  return (
    <footer className="bg-[#0b1f38] text-gray-300 pt-10 pb-6 border-t-4 border-orange-500 mt-auto">
      <div className="container mx-auto px-4 max-w-[1400px]">
        
        {/* បង្រួម gap ពី 10 មក 8 និង margin-bottom ពី 12 មក 8 */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-3">
              ទទួលបានប្រូម៉ូសិន ការបញ្ចុះតម្លៃ និងព័ត៌មានទំនិញថ្មីៗ។
            </p>
            <form className="flex bg-gray-800 rounded-lg overflow-hidden border border-gray-700" onSubmit={(e) => { e.preventDefault(); alert('អរគុណសម្រាប់ការចុះឈ្មោះ!'); }}>
              <input 
                ...
                className="bg-transparent w-full px-4 py-2.5 text-sm outline-none text-white placeholder-gray-500" 
              />
        ...
        {/* បង្រួមគម្លាតផ្នែកខាងក្រោម pt-8 មក pt-6 */}
